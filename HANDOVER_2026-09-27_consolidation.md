...
**更新（2026-09-27 夜）: 調査は9本とも完了し、確定版の計画を書いた。**
計画は `docs/CONSOLIDATION_PLAN.md`、サイトごとの直すもの121件は `docs/CONSOLIDATION_FINDINGS.md`。
調査の生データは `scratch/wf_consolidation_survey_0927_result.json`（scratch は git 管理外）。
