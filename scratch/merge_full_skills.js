...
for (let i = 1; i <= 2; i++) {
    const resPath = `C:/Users/81901/Desktop/オナーオブキングスサイト/scratch/full_results_${i}.json`;
    ...
    for (const key of Object.keys(resData)) {
        ...
        console.log(`Fully replaced skills for ${key} -> ${heroId}`);
    }
}

fs.writeFileSync(jaPath, JSON.stringify(jaData, null, 2), 'utf8');
console.log("Successfully overwrote full skills for all 10 heroes!");
