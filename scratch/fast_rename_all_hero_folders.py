...
# 1. Run batch_hero_folder_ocr.exe to get fast OCR for all folders
print("Running fast batch OCR on all 113 hero set folders...")
subprocess.run(['scratch\\batch_hero_folder_ocr.exe'], check=True)
