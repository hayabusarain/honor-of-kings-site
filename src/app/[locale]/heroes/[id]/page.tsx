                ...
                <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100/50">
                  ...
                  <div className="space-y-3">
                    {wrDetails.meta.synergy.map((syn: any, i: number) => {
                      ...
                      const displayName = matchedHero ? matchedHero.name : syn.hero_name;
                      return (
                        <div key={i} className="flex gap-3 items-start">
                          <img 
                            src={syn.hero_id ? `/images/heroes/${syn.hero_id}.jpg` : `/images/heroes/default.png`}
                            alt={displayName}
                            className="w-10 h-10 rounded-full border border-blue-200 object-cover flex-shrink-0"
                            onError={(e) => {
                              (e.target as HTMLImageElement).src = `/images/heroes/default.png`;
                            }}
                          />
                ...
                <div className="bg-rose-50/50 p-4 rounded-2xl border border-rose-100/50">
                  ...
                  <div className="space-y-3">
                    {wrDetails.meta.counters.map((cnt: any, i: number) => {
                      ...
                      const displayName = matchedHero ? matchedHero.name : cnt.hero_name;
                      return (
                        <div key={i} className="flex gap-3 items-start">
                          <img 
                            src={cnt.hero_id ? `/images/heroes/${cnt.hero_id}.jpg` : `/images/heroes/default.png`}
                            alt={displayName}
                            className="w-10 h-10 rounded-full border border-rose-200 object-cover flex-shrink-0"
                            onError={(e) => {
                              (e.target as HTMLImageElement).src = `/images/heroes/default.png`;
                            }}
                          />
