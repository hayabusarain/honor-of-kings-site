...
export default function TermsPage() {
  ...
  if (locale === 'en') {
    return (
      <div className="max-w-3xl mx-auto p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-sm my-8 border border-slate-100 dark:border-slate-800 transition-colors">
        <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100 mb-6">Terms of Service</h1>
        <div className="space-y-6 text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">2. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">3. Prohibited Activities</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">5. Changes to Terms</h2>
            <p>
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-sm my-8 border border-slate-100 dark:border-slate-800 transition-colors">
      <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100 mb-6">利用規約</h1>
      <div className="space-y-6 text-slate-600 dark:text-slate-300 leading-relaxed">
        <p>
          Honor of Kings Hub（以下「当サイト」）をご利用いただきありがとうございます。当サイトをご利用いただくにあたり、以下の利用規約（以下「本規約」）にご同意いただいたものとみなします。
        </p>
        <section>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">第1条（規約の適用）</h2>
          <p>
            本規約は、当サイトの利用者すべてに適用されます。本規約に同意できない場合は、当サイトのご利用をお控えください。
          </p>
        </section>
        <section>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">第2条（知的財産権）</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">第3条（禁止事項）</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">第4条（免責事項）</h2>
          <p>
            当サイトに掲載されている情報の正確性や最新性については細心の注意を払っておりますが、その保証はいたしかねます。当サイトの利用により生じた損害等について、運営者は一切の責任を負いません。
            詳細は<Link href="/legal" className="text-indigo-600 dark:text-indigo-400 hover:underline">免責事項</Link>のページをご確認ください。
          </p>
        </section>
        <section>
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3">第5条（規約の変更）</h2>
          <p>
