...
export const LIST_NOTES: Record<ListNotesKey, { en: Notes; ja: Notes }> = {
      ...
      sections: [
        {
          ...
          body: [
            ...
            'ここでの分類はキットの設計思想を表すもので、そのレーンに固定されるわけではありません。実戦での配置はドラフト次第で、メイジ表記のヒーローがジャングルや徘徊で選ばれることもあります。',
          ],
          list: [
            { term: 'タンク', desc: 'ダメージを受け止めて戦闘を始める。クラッシュレーンか徘徊。' },
            ...
            { term: 'サポート', desc: '味方を守り、動きを作る。徘徊枠。' },
          ],
        },
        {
          heading: '各ヒーローページの内容',
  ...
  items: {
    ...
    ja: {
      title: '装備の仕組み',
      lead: 'ショップには114種のアイテムがあり、物理・魔法・防御・移動・ジャングル・徘徊の6タブに分かれ、それぞれベーシックとアドバンスの2階層を持ちます。ビルドは6枠で、うち1枠はほぼ常に靴です。',
      sections: [
        {
        ...
        {
          heading: 'ジャングルと徘徊は、ゴールドの入り方が変わる',
          body: [
            'ジャングル装備の購入にはスマイトが必要です。モンスターからの被ダメージが25%減り、経験値とゴールドが増える代わりに、10:00までミニオンへのダメージが25%下がります。これがジャングラーがレーンを食い荒らすのを防ぐ仕組みです。',
            '徘徊装備は逆向きです。所持者は近くのミニオンやモンスターの取り分を受け取らず、代わりに20:00まで伸びる別枠の収入を得ます。サポートがレーンに立っていても隣のキャリーが枯れないのはこのためです。',
          ],
        },
        {
          heading: '徘徊装備の2系統',
          body: [
            '徘徊装備はガーディアン系と極影の盾系に分かれ、基幹はどちらも850ゴールド、完成形は2,080ゴールドです。違いは800ユニット以内の味方に配るオーラの中身にあります。',
            'どちらの系統も同じ4種の完成形を選べます。アクティブのクールダウンはチームで共有されるため、徘徊が2人いても同じ効果を連続では撃てません。',
          ],
          list: [
