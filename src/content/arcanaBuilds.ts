 ...
 *
 * 装着枠は赤・青・緑それぞれ10枠、計30枠（2026-08-20 にゲーム内のアルカナ画面で確認）。
 * ここに書いてある数値は1枠ぶん。30枠ぶんの合計は /arcana/calculator が出す。
 */
...
export const ARCANA_BUILDS: { ja: ArcanaBuild[]; en: ArcanaBuild[] } = {
  ja: [
    ...
    },
    {
      ...
      green: [{ name: '鷹の目', stats: '物理攻撃 +0.9, 物理防御貫通 +6.4' }],
      reason:
        'クリティカルは装備が揃うまで機能しにくい。紅月で攻撃速度を先に確保し、略奪のライフスティールでレーンに残る時間を伸ばす組み方。中盤以降の最大火力ではクリティカル型に劣る。',
    },
    {
      id: 'mage',
      role: 'メイジ',
    ...
    },
    {
      ...
      green: [{ name: '鷹の目', stats: '物理攻撃 +0.9, 物理防御貫通 +6.4' }],
      reason:
        'ガンクの成否は、気づかれる前に届くかどうかで決まる。青10種のうち物理攻撃と移動速度を同時に持つのは隠匿だけで、火力を落とさずに到達速度を上げられる。赤と緑で貫通を重ねるのは、狙う相手が防御を積んでいなくても、装備が揃う前の火力不足を補うため。',
    },
    {
      id: 'fighter',
      role: 'ファイター',
